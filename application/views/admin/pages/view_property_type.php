            ...
            <div class="col-sm-12">
				...
				<?php $msg=$this->input->get('m'); 
							...
							<div class="alert alert-success fade in">
                                ...
                                <strong>Success!</strong> Property Type has been Successfully Insert.
                            </div>
						<?php	}   ?>
						<?php $msg=$this->input->get('m'); 
							if($msg=='update') { ?>
							<div class="alert alert-success fade in">
                                ...
                                <strong>Success!</strong> Property Type has been Successfully Update.
                            </div>
						<?php	}   ?>
						<?php $msg=$this->input->get('m'); 
							if($msg=='delete') { ?>
							<div class="alert alert-danger fade in">
                                ...
                                <strong>Success!</strong> Property Type has been Successfully Deleted.
                            </div>
						<?php	}   ?>
					...
					<div class="position-center" id="hide">
                            <form class="form-horizontal" id="register-form" action="<?php echo base_url()."admin/property/insert_type"; ?>" method="post">
							...
							<thead>
								...
								<td class="center"><?php echo $i; ?></td>
									...
									<td><?php if(strlen($detail->content) >15): echo substr($detail->content,0,25).'...';else: echo $detail->content; endif; ?></td>
									<td>
									<?php $role=$this->session->userdata('a_role'); if($role==1){?>
									<div style="width:50%; padding-bottom:5px;">
							<button class="btn btn-success btn-xs btn-block" onclick="window.location.href='<?php echo base_url()."admin/property/edit_property_type/".base64_encode($detail->id); ?>'" type="button"><i class="fa fa-pencil"></i> Edit </button></div>
										<div style="width:50%;">
											<button class="btn btn-danger btn-xs btn-block" type="button"
											onclick="if(confirm('Do you want to delete?')) 
											return true,window.location.href='<?php echo base_url()."admin/property/property_type_delete/".$detail->id; ?>';">
