            ...
            <div class="col-sm-12">
                ...
                <section class="panel"> 
					...
					<div class="position-center" id="hide">
                            <form class="form-horizontal" id="register-form" action="<?php echo base_url()."admin/property/update_bamenity"; ?>" method="post">
							<div class="form-group">
                                <label for="name" class="col-lg-2 col-sm-2 control-label"> Name</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="name" required value="<?php echo $detail->name; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <textarea name="detail"  rows="6" cols="50"><?php echo $detail->details; ?></textarea>
                                </div>
                            </div><br>
