            ...
            <div class="col-sm-12">
                ...
                <div class="col-xs-12" id="breadcrumb" style="background-color:#1FB5AD; margin-bottom:20px; font-size:15px; color:#fff;">
					<ol class="breadcrumb pull-left" style="background-color:#1FB5AD !important;">
						...
						<li> Edit Explore Neighborhoods </li>
					</ol>
				</div>
                ...
                <section class="panel">  
					...
					<div class="position-center">
                            <form class="form-horizontal" id="register" action="<?php echo base_url()."admin/Home_highlight/update_explore"; ?>" method="post" enctype="multipart/form-data">
							<div class="form-group">
                                <label for="i_heading" class="col-lg-2 col-sm-2 control-label">Heading</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="s_heading" required id="s_heading" value="<?php echo $detail->heading; ?>" autocomplete="off">
...
<script src="<?php echo base_url() ?>assets/validate/additional-methods.min.js"></script>
    ...
    $( document ).ready(function() {
		$("#register").validate({
			...
			messages: {
				s_heading: "Please enter Heading",
