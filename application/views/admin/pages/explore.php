...
<section id="main-content">
	<section class="wrapper">
		...
		<div class="position-center" id="hide">
                            <form class="form-horizontal" id="register" action="<?php echo base_url()."admin/Home_highlight/insert_explore"; ?>" method="post" enctype="multipart/form-data">
					...
					<td class="center"><?php echo $i; ?></td>
						...
						<div style="width:50%; padding-bottom:5px;">
							<button class="btn btn-success btn-xs btn-block" onclick="window.location.href='<?php echo base_url()."admin/home_highlight/edit_explore/".base64_encode($detail->id); ?>'" type="button"><i class="fa fa-pencil"></i> Edit </button>
							<button class="btn btn-danger btn-xs btn-block" type="button"
							onclick="if(confirm('Do you want to delete?')) 
							return true,window.location.href='<?php echo base_url()."admin/home_highlight/delete_explore/".$detail->id; ?>';">
