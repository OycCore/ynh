            ...
            <div class="col-sm-12">
				...
				<?php $msg=$this->input->get('m'); 
					...
					<div class="position-center" id="hide">
                            <form class="form-horizontal" id="register-form" action="<?php echo base_url()."admin/property/insert_bamenity"; ?>" method="post">
							...
							<button class="btn btn-success btn-xs btn-block" onclick="window.location.href='<?php echo base_url()."admin/property/edit_building_amenity/".base64_encode($detail->id); ?>'" type="button"><i class="fa fa-pencil"></i> Edit </button></div>
										<div style="width:50%;">
											<button class="btn btn-danger btn-xs btn-block" type="button"
											onclick="if(confirm('Do you want to delete?')) 
											return true,window.location.href='<?php echo base_url()."admin/property/bamenity_delete/".$detail->id; ?>';">
