        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="col-xs-12" id="breadcrumb" style="background-color:#1FB5AD; margin-bottom:20px; font-size:15px; color:#fff;">
					...
					<button type="button" id="show" class="btn btn-round btn-primary"> Add New Bus </button>
				</div>
                <section class="panel">
				<?php $msg=$this->input->get('m'); 
			        if($msg=='success') {  ?>
				           <div class="alert alert-success fade in">
                                ...
                                <strong>Success!</strong> Bus Successfully Insert.
                            </div>
		            <?php	} ?>
					<?php $msg=$this->input->get('m'); 
							if($msg=='delete') { ?>
							<div class="alert alert-danger fade in">
                                ...
                                <strong>Success!</strong> Bus Successfully Deleted.
                            </div>
						<?php	}   ?>
                    <div class="panel-body">
					<div class="position-center" id="hide">
                            <form class="form-horizontal" id="register-form" action="<?php echo base_url()."admin/property/insert_bus"; ?>" method="post">
							<div class="form-group">
                              <label for="name" class="col-lg-2 col-sm-2 control-label">Bus Name</label>
                                <div class="col-lg-10">
                                   <input type="text" class="form-control" name="name" required id="name" placeholder="Bus Name" autocomplete="off" autofocus>
                                </div>
                            </div><br>
                            <div class="form-group">
									...
									<td><?php if(strlen($detail->description) >15): echo substr($detail->description,0,25).'...';else: echo $detail->description; endif; ?></td>
										...
										<?php $role=$this->session->userdata('a_role'); if($role==1){?>
										    <div style="width:50%;">
												...
												return true,window.location.href='<?php echo base_url()."admin/property/delete_bus/".$detail->id; ?>';">
