            ...
            <div class="col-sm-12">
                ...
                <div class="col-xs-12" id="breadcrumb" style="background-color:#1FB5AD; margin-bottom:20px; font-size:15px; color:#fff;">
					<ol class="breadcrumb pull-left" style="background-color:#1FB5AD !important;">
						...
						<li> Include Listing </li>
					</ol>
					<button type="button" id="show" class="btn btn-round btn-primary"> Add New Listing </button>
				</div>
				...
				<?php $msg=$this->input->get('m'); 
							...
							<div class="alert alert-success fade in">
                                ...
                                <strong>Success!</strong> Listing has been Successfully Insert.
                            </div>
						<?php	}   ?>
						<?php $msg=$this->input->get('m'); 
							if($msg=='update') { ?>
							<div class="alert alert-success fade in">
                                ...
                                <strong>Success!</strong> Listing has been Successfully Update.
                            </div>
						<?php	}   ?>
						<?php $msg=$this->input->get('m'); 
							if($msg=='delete') { ?>
							<div class="alert alert-danger fade in">
                                ...
                                <strong>Success!</strong> Listing has been Successfully Deleted.
                            </div>
						<?php	}   ?>
					...
					<div class="position-center" id="hide">
                            <form class="form-horizontal" id="register-form" action="<?php echo base_url()."admin/property/insert_listing"; ?>" method="post">
							...
							<button class="btn btn-success btn-xs btn-block" onclick="window.location.href='<?php echo base_url()."admin/property/edit_include_listing/".base64_encode($detail->id); ?>'" type="button"><i class="fa fa-pencil"></i> Edit </button></div>
										<div style="width:50%;">
											<button class="btn btn-danger btn-xs btn-block" type="button"
											onclick="if(confirm('Do you want to delete?')) 
											return true,window.location.href='<?php echo base_url()."admin/property/delete_listing/".$detail->id; ?>';">
