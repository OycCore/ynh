...
<section id="main-content">
	<section class="wrapper">
        ...
        <div class="row">
			...
			{ ?>
				<div class="alert alert-success fade in">
                                ...
                                <strong>Success!</strong> Service has been Inserted Successfully.
                            </div>
		<?php	} ?>
		 <?php $msg=$this->input->get('m'); 
			if($msg=='update')
			{ ?>
				<div class="alert alert-info fade in">
                                ...
                                <strong>Success!</strong> Service Has been Updated Successfully.
                            </div>
		<?php	} ?>
		 <?php $msg=$this->input->get('m'); 
			if($msg=='delete')
		...
		<div class="position-center" id="hide">
                            <form class="form-horizontal" id="register" action="<?php echo base_url()."admin/Home_highlight/insert_service"; ?>" method="post" enctype="multipart/form-data">
							<div class="form-group">
                                <label for="s_heading" class="col-lg-2 col-sm-2 control-label">Heading</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="s_heading" required id="s_heading" placeholder="Heading" autocomplete="off" autofocus>
                                </div>
                            </div><br>
					...
					<td class="center"><?php echo $i; ?></td>
						<td class="center"><img src="<?php echo base_url()."assets/images/".$detail->image; ?>" width="70" height="70"></td>
						<td><?php echo $detail->heading; ?></td>
						<td>
						<div class="col-sm-4" style=" padding:5px 0px;">
							<button class="btn btn-success btn-xs btn-block" onclick="window.location.href='<?php echo base_url()."admin/Home_highlight/edit_service/".base64_encode($detail->id); ?>'" type="button"><i class="fa fa-pencil"></i> Edit </button>
							<button class="btn btn-danger btn-xs btn-block" type="button"
							onclick="if(confirm('Do you want to delete?')) 
							return true,window.location.href='<?php echo base_url()."admin/Home_highlight/delete_service/".$detail->id; ?>';">
